...
internal class CalendarBottomSheetPreviewData :
    PreviewParameterProvider<CaramelDefaultBottomTodoScope> {
    ...
    override val values: Sequence<CaramelDefaultBottomTodoScope>
        get() = sequenceOf(
            ...
            CaramelDefaultBottomTodoScope(
                ...
                description = "내용이4줄넘어가는건지내용이4줄넘어가는건지내용이4줄넘어가는건지내용이4줄넘어가는건지내용이4줄넘어가는건지내용이4줄넘어가는건지내용이4줄넘어가는건지내용이4줄넘어가는건지내용이4줄넘어가는건지내용이4줄넘어가는건지",
                url = null,
                role = ContentRole.MY,
                onClickUrl = {},
                onClickTodo = {}
