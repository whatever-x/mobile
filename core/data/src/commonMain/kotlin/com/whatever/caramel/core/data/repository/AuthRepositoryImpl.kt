...
internal class AuthRepositoryImpl(
    ...
    override suspend fun refreshAuthToken(oldToken: AuthToken): RefreshUserSessionResult =
        safeCall {
            val request =
                ServiceTokenDto(
            ...
            val response = remoteAuthDataSource.refreshV2(request = request)
            response.toRefreshUserSessionResult()
        }
